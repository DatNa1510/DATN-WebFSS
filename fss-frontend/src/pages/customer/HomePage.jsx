...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_BASE}/api/products?limit=3&sort=best-seller`)
      .then(res => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_BASE}/api/products?limit=8&category=${activeCategory}&sort=best-seller`)
              ...
              <div className="group relative w-full rounded-[2rem] overflow-hidden shadow-elevation ring-1 ring-black/5 bg-slate-100">
                <AnimatePresence mode="wait">
                  {heroProduct.id && (
                    ...
                    >
                      <img
                        src={heroProduct.imagePath ? (heroProduct.imagePath.startsWith('http') ? heroProduct.imagePath : heroProduct.imagePath.startsWith('/') ? `${API_BASE}${heroProduct.imagePath}` : `${API_BASE}/images/${heroProduct.imagePath}`) : (heroProduct.images?.[0] || 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=400&q=60')}
