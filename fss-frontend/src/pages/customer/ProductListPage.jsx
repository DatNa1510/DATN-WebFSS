          ...
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap lg:flex-nowrap items-center gap-4 w-full lg:w-auto">
              ...
              <div className="flex gap-1.5 overflow-x-auto lg:overflow-visible py-1">
                {allCategories.map((cat) => (
                  <button
                    ...
                    className={`shrink-0 px-4 py-2.5 rounded-sm text-[11px] font-black uppercase tracking-widest border-2 transition-all duration-200 ${
              ...
              <div className="relative flex-1 lg:flex-none lg:min-w-[160px] group">
                <div className="relative flex items-center bg-white border-2 border-slate-200 rounded-sm hover:border-slate-300 transition-colors shadow-sm">
                  <select
                    ...
                    className="w-full bg-transparent pl-4 pr-10 py-3.5 text-[14px] font-black text-slate-700 appearance-none cursor-pointer outline-none"
                  >
                    {sortOptions.map((o) => (
              ...
              <button
                ...
                className={`flex-1 lg:flex-none flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-sm font-black text-[12px] uppercase tracking-widest transition-all duration-300 border-2 ${
                  showFilters
              ...
              <Link
                to="/visual-search"
                className="flex-1 lg:flex-none flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-sm font-black text-[12px] uppercase tracking-widest transition-all duration-300 border-2 border-[#00168d] bg-transparent text-[#00168d] hover:bg-[#00168d] hover:text-white hover:-translate-y-0.5 shadow-sm"
              >
                <Camera size={14} />
                    ...
                    {priceRanges.map((range, i) => (
                      <label key={i} className="flex items-center gap-3 cursor-pointer group">
                        <div
                          ...
                          className={`w-4 h-4 flex items-center justify-center border-[2px] rounded-sm transition-all cursor-pointer ${
                            priceRange === i ? 'border-[#00168d] bg-[#00168d]' : 'border-slate-300 group-hover:border-[#00168d]'
                          }`}
                        >
                        ...
                        <span
                          ...
                          className={`text-[13px] font-bold transition-colors cursor-pointer ${
                            priceRange === i ? 'text-[#00168d]' : 'text-slate-600 group-hover:text-slate-800'
                          }`}
                        >
                          {range.label}
                        </span>
              ...
              {Array.from({ length: Math.ceil(total / PAGE_SIZE) }).map((_, i) => {
                ...
                return (
                  <button
                    ...
                    className={`w-10 h-10 flex border-2 items-center justify-center rounded-sm font-black transition-all ${
                      page === i 
